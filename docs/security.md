...
See [the current review](REVIEW_2026-09-22.md) for unresolved security and durability work. Optional CLI manifest HMAC provides shared-key authentication, not independent public-key identity or non-repudiation.
