...
| AW-08 | Strict config and persisted record shapes, mutation-only commands, numeric overflow rejection, UTC calendar checks, JSON usage envelopes and public schema tests | Contract suite passes 22 assertions; authentication suite passes nine. |
