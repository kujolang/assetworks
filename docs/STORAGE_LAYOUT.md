...
The release-instruction revision `1cef9b0` in [run 35791495202](https://github.com/kujolang/assetworks/actions/runs/35791495202) repeated the drill successfully: migration 600,317 ms (12.8 CPU seconds; 25,649,152-byte peak RSS), full inspection 44,092 ms (174,235,648-byte peak RSS), and a 1 ms first raw page scanning 393 entries. Preserve this slower result when estimating maintenance windows: observed migration wall time ranged from about 55 seconds to 10 minutes across these runners.
