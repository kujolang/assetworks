...
AssetWorks is local-first and process-safe for per-record writes. It is not a distributed multi-host scheduler, hosted identity provider, or publication gateway. Those are explicit integration boundaries rather than hidden promises.
